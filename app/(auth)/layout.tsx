...
export default function AuthLayout({
  ...
  return (
    <main className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0 bg-[#0E7E6F] bg-gradient-to-b from-[#0E7E6F] via-[#0A6A60] to-[#095A50]"></div>

      {/* Abstract Background Elements */}
      <div className="absolute inset-0 overflow-hidden">
        {/* Animated gradient blobs - optimized for mobile */}
        <div
          className="absolute -right-[30%] sm:-right-[35%] -top-[35%] w-[80%] sm:w-[70%] aspect-square rounded-full bg-[#14A698]/30 blur-3xl animate-blob"
          style={{ animationDuration: "15s" }}
        />
        <div
          className="absolute -left-[25%] sm:-left-[15%] -bottom-[25%] w-[70%] sm:w-[50%] aspect-square rounded-full bg-[#14B6A8]/25 blur-3xl animate-blob"
          style={{ animationDuration: "25s", animationDelay: "2s" }}
        />
        <div
          className="absolute left-[25%] sm:left-[35%] top-[25%] sm:top-[15%] w-[40%] sm:w-[30%] aspect-square rounded-full bg-[#0CCBBB]/20 blur-3xl animate-blob"
          style={{ animationDuration: "20s", animationDelay: "5s" }}
        />
        <div
          className="absolute right-[10%] sm:right-[20%] bottom-[15%] sm:bottom-[20%] w-[45%] sm:w-[40%] aspect-square rounded-full bg-[#0BA99D]/15 blur-3xl animate-blob"
          style={{ animationDuration: "18s", animationDelay: "7s" }}
        />

        {/* Geometric abstract shapes - responsive */}
        {isClient && (
          <>
            {/* Triangle */}
            <div
              ...
              style={{
                top: "20%",
                left: "5%",
                background: "linear-gradient(45deg, #14A698, #14D1BF)",
            ...
            <div
              ...
              style={{
                bottom: "15%",
                left: "65%",
                background: "linear-gradient(135deg, #14D1BF, transparent)",
            ...
            <div
              ...
              style={{
                top: "55%",
                right: "10%",
                background: "linear-gradient(to right, #14A698, transparent)",
                animationDelay: "2s",
              }}
            />
            ...
            {/* Ring */}
            <div
              className="absolute w-32 sm:w-64 h-32 sm:h-64 border-2 sm:border-4 border-[#14D1BF]/10 rounded-full animate-spin-slow"
              style={{
                top: "35%",
                right: "15%",
              }}
        ...
        <div
          className="absolute bottom-0 left-0 right-0 h-24 sm:h-32 opacity-30"
          style={{
            background:
