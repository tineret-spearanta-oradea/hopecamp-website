...
export default function UniteIntroSlide() {
  return (
    <div className="relative h-full w-full overflow-hidden">
      ...
      <div className="relative z-10 h-full flex flex-col items-center justify-center px-6">
        ...
        >
          ...
          >
            Dintre toate serile, una singură deține
          </motion.p>
          <motion.h2
          ...
          <motion.p
            ...
            className="font-nunito text-purple-300/80 text-base mt-4"
          >
            pentru numărul de participanți
          </motion.p>
        </motion.div>
      </div>
    </div>
