...
export default function MinistryIntroSlide() {
  return (
    <div className="relative h-full w-full overflow-hidden">
      ...
      {/* Animated glow */}
      <motion.div
        className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-64 h-64 bg-teal-500/20 rounded-full blur-3xl"
        animate={{
          scale: [1, 1.5, 1],
          opacity: [0.3, 0.6, 0.3],
        }}
      ...
      <div className="relative z-10 h-full flex flex-col items-center justify-center px-6">
        ...
        >
          ...
          <motion.p
            ...
            className="font-nunito text-teal-300/80 text-base mt-4"
          >
            🎤
          </motion.p>
        </motion.div>
