...
export default function HopeCampGallerySlideOne() {
  return (
    <div className="relative h-full w-full overflow-hidden">
      ...
      <div className="relative z-10 h-full flex flex-col items-center justify-center px-6">
        ...
        <motion.div
          ...
          transition={{ delay: 1 }}
          className="text-center bg-black/40 backdrop-blur-sm px-6 py-4 rounded-2xl border border-white/10"
        >
           <p className="font-nunito text-white text-base md:text-lg  mb-1">
            Momente din Hope Camp #6 ✨
          </p>
        </motion.div>
      </div>
    </div>
