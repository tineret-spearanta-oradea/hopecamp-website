...
export default function DonatiiPage() {
  ...
  return (
    <main className="min-h-screen">
      <Navbar />
      <div className="container mx-auto py-16 px-4 md:px-6 max-w-4xl mt-10 lg:mt-16">
            ...
            <CardContent className="p-6">
              <div className="flex flex-col md:flex-row gap-4 items-center">
                <div className="flex-1">
                  <p className="mb-3">
                    Poți trimite bani instant prin Revolut utilizând link-ul de
                    mai jos:
                  </p>
                  <a
                    href={revolutLink}
                  ...
                  >
                    revolut.me/eugennathan <ExternalLink className="h-4 w-4" />
                  </a>
                </div>
                <div>
                  <Button
