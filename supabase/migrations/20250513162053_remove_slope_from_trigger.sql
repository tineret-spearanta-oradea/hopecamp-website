-- First, remove the slope_activity column from the registrations table
ALTER TABLE registrations DROP COLUMN slope_activity;

-- Then, update the handle_new_user() function to remove the slope_activity field
